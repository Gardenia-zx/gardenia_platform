...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
                                                   AccessOnlyJwtAuthenticationConverter accessOnlyJwtAuthenticationConverter, JwtDecoder jwtDecoder) throws Exception {
        http
                ...
                .oauth2ResourceServer(oauth -> oauth
                        .jwt(jwt -> jwt
                                .jwtAuthenticationConverter(accessOnlyJwtAuthenticationConverter))
                );
        return http.build();
    }
