...
public class AuthProperties {
    ...
    private final LoginRisk loginRisk = new LoginRisk();
    ...
    public static class LoginRisk {
         ...
         * 账号维度失败阈值。
         */
        private int identifierFailureThreshold = 5;

        /**
         * IP 维度失败阈值。
         */
        private int ipFailureThreshold = 20;

        /**
         * 账号+IP 组合维度失败阈值。
         */
        private int pairFailureThreshold = 8;
    }
}
