...
public class AuthController {
     ...
     */
    @PostMapping("/logout")
    public ResponseEntity<Void> logout(@Valid @RequestBody LogoutRequest request,@AuthenticationPrincipal Jwt jwt) {
        authService.logout(request.refreshToken(),jwt);
    ...
    public ResponseEntity<Void> resetPassword(@Valid @RequestBody PasswordResetRequest request,@AuthenticationPrincipal Jwt jwt) {
